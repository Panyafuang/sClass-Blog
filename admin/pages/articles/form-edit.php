          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" name="tags[]" multiple="multiple" data-placeholder="Select a Tags" style="width: 100%;">
                <option value="eyebrow" <?php echo in_array('eyebrow', $arr_tag) ? 'selected': ''; ?>>eyebrow</option>
                <option value="eyeliner" <?php echo in_array('eyeliner', $arr_tag) ? 'selected': ''; ?>>eyeliner</option>
                <option value="lips" <?php echo in_array('lips', $arr_tag) ? 'selected': ''; ?>>lips</option>
                <option value="waxing" <?php echo in_array('waxing', $arr_tag) ? 'selected': ''; ?>>waxing</option>
                <option value="makeup" <?php echo in_array('makeup', $arr_tag) ? 'selected': ''; ?>>makeup</option>
              </select>
            </div>
      ...
      if(size.toFixed(2) > 2){
        ...
        if (this.files[0]) {
            ...
            reader.onload = function (e) {
                $('#imgUpload').attr('src', e.target.result).width(500);
            }
